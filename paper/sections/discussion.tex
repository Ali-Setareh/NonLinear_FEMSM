...
does not guarantee that this latent factor is the correct one for the 
...
direction is to 
investigate the theoretical properties of the fixed-effect estimates by FE-MSM and the 
...
whether the consistency assumption for SeqGPLVM can be enforced 
