...
To evaluate the finite sample performance of the two proposed method, 
...
values for the causal targets of interests coincide wit the DGP parameters. 
...
To only focus 
on the adjustment for the unmeasured confounder, for both of the methods, 
