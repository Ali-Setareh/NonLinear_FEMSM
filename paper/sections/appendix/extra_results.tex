...
\begin{figure}[t]
    \centering
    \includegraphics[width=0.98\textwidth]{figures/build/simulation_bias_combined_a_p4.pdf}
...
\begin{figure}[t]
    \centering
    \includegraphics[width=0.98\textwidth]{figures/build/simulation_standard_error_combined_a_p4.pdf}
...
\begin{figure}[t]
    \centering
    \includegraphics[width=0.98\textwidth]{figures/build/simulation_coverage_combined_a_p4.pdf}
