...
\]
In SeqGPLVM, we model these mappings as non-parametric functions using Gaussian processes (GPs), 
...
The likelihood term \(p(a_{i,t} \mid f_t)\) depends on the type of treatment variable. 
