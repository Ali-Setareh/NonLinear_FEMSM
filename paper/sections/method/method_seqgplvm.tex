...
covariates and the estimated unmeasured confounder substitute, and (iii) a marginal
...
with any other estimation methods as well, such as g-computation or doubly
...
\begin{idassumpSG}[Conditional Markov treatment model]\label{ass:SG-Marcovianity}
    \begin{equation}
...
assumption is the dynamic version of no-single-cause assumption in \cite{wangBlessingsMultipleCauses2019}. It rules 
...
\begin{idassumpSG}[No single-time-point confounding]
...
\begin{idassumpSG}[Consistency of the confounder substitute]
