...
causal in nature because they ask about the effect of an intervention on an outcome. 
...
treatments and outcome(s). In presence of such feedback loops, naive standard regression methods that 
adjust for 
...
\cite{wangBlessingsMultipleCauses2019} where 
...
These two methods are comparable as they can be used in settings such as those described above. They both involve a 
...
developed using the \texttt{GPyTorch} \cite{gardnerGPyTorchBlackboxMatrixMatrix2021}. 
...
%which include inverse probability of treatment weighting (IPTW) of marginal structural 
%models \cite{robinsMarginalStructuralModels2000}, 
%the g-formula \cite{snowdenImplementationGComputationSimulated2011}, and 
%g-estimation of structural nested models \cite{vansteelandtStructuralNestedModels2014}.
